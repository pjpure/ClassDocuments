...
LedControl lc=LedControl(7,6,5,4);  // DIN,CLK,CS,Number of LED Module
uint8_t intensity = 1;
...
void degree(int degreeX)
{
  print_tiny_char( 12, 1,  degreeX / 10 + '0'); //print degree
  print_tiny_char( 17, 1,  degreeX % 10 + '0');
